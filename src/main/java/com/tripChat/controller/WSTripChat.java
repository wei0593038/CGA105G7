...
import com.tripChat.jedis.JedisHandleMessage;
...
public class WSTripChat {
	...
	public void onOpen(@PathParam("tripId") String tripId, Session sessions) {
		...
		List<String> historyMsg = JedisHandleMessage.getHistoryMsg(tripId);
	...
	public void onMsg(String msg, Session userSession) {
		...
		JedisHandleMessage.saveChatMessage(tripId, msg);
